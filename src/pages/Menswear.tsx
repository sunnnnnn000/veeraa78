...
const Menswear: React.FC = () => {
  ...
  const [products] = useState(getProductsByCategory('menswear'));
  ...
  const priceRanges = [
    ...
    { id: 'under-1000', name: 'Under ₹1000', min: 0, max: 1000 },
    { id: '1000-2000', name: '₹1000 - ₹2000', min: 1000, max: 2000 },
    { id: '2000-4000', name: '₹2000 - ₹4000', min: 2000, max: 4000 },
    { id: '4000-6000', name: '₹4000 - ₹6000', min: 4000, max: 6000 },
    { id: 'above-6000', name: 'Above ₹6000', min: 6000, max: Infinity }
  ];
  ...
  const sizes = ['S', 'M', 'L', 'XL', 'XXL', '7', '8', '9', '10', '11', '12', '32', '34', '36', '38', '40', '42'];
  ...
  useEffect(() => {
    ...
    if (selectedCategory !== 'all') {
      filtered = getProductsBySubcategory('menswear', selectedCategory);
    }
  ...
  }, [selectedCategory, selectedPriceRange, selectedBrands, selectedSizes, sortBy, products]);
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Men's Fashion</h1>
              <p className="text-gray-600 mt-2">
                Discover premium clothing and accessories for the modern man
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {sizes.map((size) => (
                    <label key={size} className={`flex items-center justify-center border rounded-lg p-2 hover:bg-gray-50 cursor-pointer ${
                      selectedSizes.includes(size) ? 'border-blue-500 bg-blue-50 text-blue-600' : 'border-gray-300'
                    }`}>
                      <input 
                        type="checkbox" 
                        className="sr-only"
